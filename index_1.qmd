...
::: {style="font-size:0.85rem; line-height:1.4; max-width:180px;"}
Visualiza las hojas de vida que los candidatos a las Elecciones Generales 2026 declararon ante el JNE.
:::
...
output$plot_ingresos_partido <- renderPlotly({
  ...
  layout(
    title = titulo_plotly("Ingreso promedio declarado por partido",
...
output$plot_sexo_partido <- renderPlotly({
  ...
  plot_ly(base_fem,
    ...
    marker = list(color = "#02a1c7"),   # azul definido inline para no depender del theme
...
output$plot_ranking_candidatos_sent <- renderPlotly({
  ...
  layout(
    title = titulo_plotly("Candidatos con más sentencias",
                          "Top 20 · hover para ver materias y fallos"),
...
output$plot_sin_trayectoria <- renderPlotly({
  ...
  layout(
    title = titulo_plotly(
      ...
      "Top 10 candidatos sin exp. laboral, cargos partidarios ni elección popular declarados ante el JNE"
    ),
    xaxis = list(color = blanco, gridcolor = gris_claro,
                 tickformat = ",.0f", tickprefix = "S/ ",
                 tickfont = list(family = "Cabin")),
